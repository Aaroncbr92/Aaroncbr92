...
- **Tema**: Escenografía e iluminación. Nuevas tendencias.
- **Preguntas de la materia**: **20**. Es **la materia más preguntada de todo el bloque
  específico**: una de cada seis de las ciento veintitrés.
...
| 77 · 90 | c | Rojo + azul = magenta; su complementario es el verde | **UIT-R BT.601-7**, cuadro 1 | 1.4 |
| 77 · 96 | b | Los props se piden al departamento de Arte | Plantilla oficial | 2.1 |
| 78 · 11 | c | Las luces cálidas tienen temperatura de color baja | Uso profesional | 1.2 |
...
| 78 · 71 | d | Limbo: escenografía neutra que no informa del lugar | Plantilla oficial | 2.1 |
| 78 · 85 | b | Dimmer: dispositivo que regula la intensidad de la luz | Uso profesional | 1.6 |

## Las cuatro que sí tienen norma, y cómo se llega a ellas

**1. El flujo luminoso (78 · 58).** El **RD 2032/2009**, de unidades legales de medida, da las
cuatro magnitudes de la familia, y las cuatro están entre las opciones: **candela** (intensidad
luminosa, unidad básica), **lumen** (flujo luminoso, **cd · sr**), **lux** (iluminancia,
**lm/m²**) y **kelvin** (temperatura). La respuesta es el **lumen**, y la manera de no fallarla no
es memorizar sino saber **qué mide cada una**: la candela, la luz que sale de la fuente en una
dirección; el lumen, la que sale en total; el lux, la que llega a la superficie.

**2. El complementario del magenta (77 · 90).** Es la única pregunta del tema con una fuente
cerrada para la parte difícil. El enunciado encadena dos pasos: **rojo + azul**, y luego el
complementario del resultado. El **cuadro 1 de la Recomendación UIT-R BT.601-7**, «Valores de las
señales normalizados», da **magenta = E'R 1,0 / E'G 0 / E'B 1,0**: es decir, **rojo + azul**. Y
como el complementario de un secundario aditivo es **el primario que le falta**, el complementario
del magenta es **el verde**. La trampa del enunciado es que **magenta figura entre las opciones**,
para quien se quede a mitad del camino.

**3. La transmisión de la luz (77 · 86).** No es norma sino física, pero se demuestra: el
enunciado —«atraviesa una superficie no opaca y sus rayos, al cambiar de medio, pasan difusa o
directamente»— describe la **transmisión**. El distractor bueno es **refracción**, que es sólo el
**desvío** al cambiar de medio, no el hecho de atravesar y salir. *(Nota: esta pregunta figura en
el acta del reparto en este tema, no en el 10, aunque su materia toque las dos.)*

**4. La toma de tierra del practicable (78 · 40).** Es la que exigió más cuidado, porque **la
respuesta oficial no está escrita en ninguna norma**. Lo que sí está es el marco: la **ITC-BT-24**
del **Reglamento electrotécnico para baja tensión** (RD 842/2002), en su capítulo 4, regula la
protección contra **contactos indirectos** —los que se producen cuando **una masa queda
accidentalmente en tensión**—, con el **corte automático de la alimentación** como medida
principal, la coordinación con **el esquema de conexiones a tierra** y una **tensión límite
convencional de 50 V** en alterna. De ahí a un practicable hay un paso que **da el oficio, no el
...
- **El enunciado de la 77 · 78 tiene los términos invertidos.** Dice «superponer una imagen real
  ...
  quien intente razonar el enunciado al pie de la letra se bloquea. El tema **recoge la respuesta
  y señala el error** en vez de callarlo.
- **La opción correcta de la 77 · 44 dice «marca comercial alemana».** El tema afirma que son
  **tubos LED de una marca comercial** y **se detiene ahí**: la nacionalidad del fabricante no se
  ha podido confirmar en ninguna fuente, y no hace falta para acertar la pregunta —las otras tres
  opciones describen balastos, bastidores y viseras—. Apartado 1 del manual: lo que no se confirma,
  no se escribe.
...
- Del **RD 2032/2009**: las definiciones de **candela** y **lux**, que son los distractores de la
  pregunta del lumen y pueden ser la pregunta la próxima vez; y la definición exacta de la candela
  —eficacia luminosa de la radiación de **540 × 10¹² Hz** fijada en **683 lm/W**—.
- Del **cuadro 1 de la BT.601-7**: los otros dos pares de complementarios, **amarillo ↔ azul** y
  **cian ↔ rojo**. Si ya ha caído uno, los otros dos son la continuación natural.
- De la documentación de escenografía: la pareja **planta / plano de cámaras**, que acompaña al
  **alzado** en los mismos planos y son sus propios distractores.
- Del vocabulario ya recogido: **forillo** frente a **limbo** —el examen usó el forillo como
  distractor; puede preguntarlo de frente— y **visera / barndoor** frente a **dimmer**, por la
  misma razón.
