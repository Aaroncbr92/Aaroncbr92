# BOE-A-2026-7558 — texto consolidado, redacción vigente hoy

Volcado con `herramientas/boe.py norma` el 2026-09-24 desde la API de
legislación consolidada del BOE. Fuente: https://www.boe.es/buscar/act.php?id=BOE-A-2026-7558

No se edita a mano. Si hace falta refrescarlo, se vuelve a volcar.

## [no] (sin título)

_Redacción aplicable desde 20260620, publicada 20260320, por BOE-A-2026-7558. 1 redacción(es) en total._
...
_**El BOE no sirve este bloque** (error de red: curl: (18) transfer closed with outstanding read data remaining). Está en el índice de la norma y su texto no se ha podido leer: no lo des por vacío, léelo en la web._
