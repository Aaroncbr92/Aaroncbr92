# BOE-A-2016-7303 — texto consolidado, redacción vigente a 20221221

Volcado con `herramientas/boe.py norma` el 2026-09-03 desde la API de
legislación consolidada del BOE. Fuente: https://www.boe.es/buscar/act.php?id=BOE-A-2016-7303

No se edita a mano. Si hace falta refrescarlo, se vuelve a volcar.

## [pr] [preambulo]

_Redacción aplicable desde 20160730, publicada 20160729, por BOE-A-2016-7303. 1 redacción(es) en total._
...
0,5 mT
Riesgo de atracción y proyección de objetos en la proximidad de campos magnéticos intensos (> 100 mT)
3 mT
...
NA (B) superior
[μT] (RMS)
NA para exposición de las extremidades a campo magnético localizado
[μT] (RMS)
1 ≤ f < 8 Hz
2,0 × 105/f2
3,0 × 105/f
...
VLE relacionados con efectos para la salud
SAR promediado a lo largo de cualquier período de seis minutos
VLE para el estrés térmico de cuerpo completo, expresado como SAR promediado para cuerpo entero
0,4 W/kg
VLE para el estrés térmico en la cabeza y tronco, expresado como SAR localizado en cabeza y tronco
10 W/kg
VLE para el estrés térmico en las extremidades, expresado como SAR localizado de las extremidades
20 W/kg
...
Intervalo de frecuencias
Absorción específica de energía localizada
(SA)
0,3 ≤ f≤ 6 GHz
10 mJ/kg
...
Intervalo de frecuencias
NA (E) de campo eléctrico
[V/m] (RMS)
NA (B) de inducción magnética
[μT] (RMS)
NA (S) de densidad de potencia
[W/m2]
100 kHz ≤ f < 1 MHz
6,1 × 102
2,0 × 106/f
...
Intervalo de frecuencias
NA (IC) corrientes de contacto en estado estacionario
[mA] (RMS)
NA (IL) corrientes inducidas en extremidades
[mA] (RMS)
100 kHz ≤ f < 10 MHz
40
–
