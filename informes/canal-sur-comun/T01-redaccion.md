...
Tema: `temas/canal-sur-comun/01-constitucion-espanola.md`. Punto 1 del temario común de
Canal Sur, rúbricas a), b) y c). Fase 2 (redactar), un solo agente. Fecha de trabajo y de
