# T02 · Redacción · Estatuto de Autonomía para Andalucía, instituciones y Administración de la Junta

Tema: `temas/canal-sur-comun/02-estatuto-autonomia-andalucia.md`. Punto 2 del temario común de
Canal Sur (enunciado literal, con sus rúbricas a y b, en `convocatoria/canal-sur/PROGRAMA-COMUN.md`;
«El Presidencia» se transcribe tal cual, errata del BOJA). Fase 2 (redactar), un solo agente.
**Fecha de trabajo y de lectura de todos los preceptos: 24-09-2026.**

(En curso: se completa según avanza la redacción.)

## Material de partida

- `informes/canal-sur-comun/T02-investigacion-estatuto.md`
