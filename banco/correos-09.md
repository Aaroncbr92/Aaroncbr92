# Correos · Tema 9 · Procesos operativos III: distribución y entrega
...
**Cuestionario-ATC_A_07052023 · nº 15 · respuesta: c**

```
De los siguientes tipos de envíos, hay uno que por sus características no tiene entrega domiciliaria y por tanto su entrega siempre será en la oficina. ¿Cuál es?
...
```
¿A través de qué canales se puede contratar el servicio "Buzón de vacaciones"?
...
**Cuestionario-ATC_A_07052023 · nº 21 · respuesta: a**

```
¿Qué tipología de envíos entran en el almacén de archivo de una oficina?
...
```
En relación con las modalidades del reenvío postal, indique cuál de las siguientes afirmaciones es correcta:
...
**Cuestionario-ATC_A_07052023 · nº 43 · respuesta: a**

```
Indique cuál de las siguientes afirmaciones es correcta, en relación con la entrega en una oficina de un producto de paquetería a un menor de edad:
...
```
Entre las siguientes, ¿qué tipología de entrega en oficinas no existe actualmente?
...
**Cuestionario-ATC_A_07052023 · nº 71 · respuesta: b**

```
¿Qué tipo de envíos contra reembolso se entregan en una oficina?
...
```
¿Cuáles son los ámbitos de suscripción posibles de un reenvío postal?
...
**Cuestionario-REP_A_07052023 · nº 1 · respuesta: a**

```
En una unidad de distribución, ¿cuál de las siguientes tareas no es de carácter colectivo?
a) El embarriado
b) La descarga
c) La apertura
...
```
¿Cuál de los siguientes trámites con la DGT puede realizar un rural mediante la PDA?
...
**Cuestionario-REP_A_07052023 · nº 17 · respuesta: b**

```
¿Cómo se procede en las unidades de distribución con los envíos recibidos que tienen modalidad de entrega en oficina?
...
```
En las unidades de distribución, ¿se dan de alta en unidad, diariamente, todas las notificaciones recibidas en el día que no salgan a reparto?
...
**Cuestionario-REP_A_07052023 · nº 26 · respuesta: c**

```
Si durante la recepción de envíos en las unidades de distribución se detecta una incidencia en algún envío estacionable, se estaciona en SGIE por asignación directa. ¿Cuál de las siguientes incidencias no es una posible causa de estacionamiento por asignación directa?
a) Rotura
...
```
En el caso de que haya que priorizar la entrega de envíos registrados en las unidades de distribución, ¿cuál de las siguientes opciones contiene un orden correcto de prioridad, si se ordenan de más a menos prioritario?
...
**Cuestionario-REP_A_07052023 · nº 45 · respuesta: b**

```
Durante el embarriado en las unidades de distribución, ¿se debe priorizar el embarrie del contenido de la bolsa de alcance sobre el contenido del carro de reparto o cofre de moto?
...
```
En las unidades de distribución, ¿para cuál de los siguientes productos no es obligatorio recoger la firma en la PDA durante el proceso de entrega registrada?
a) Telegrama
b) Burofax
c) Paq estándar
d) Notificaciones
...
**Cuestionario-REP_A_07052023 · nº 57 · respuesta: b**

```
La entrega de correspondencia con el valor añadido de «Entrega exclusiva al destinatario», se realizará siempre a personas físicas y mayores de… (señale la respuesta correcta):
a) 16 años
b) 14 años
c) 18 años
d) 21 años
...
```
¿Cómo se clasifican los servicios rurales, en función de dónde realizan el inicio de su jornada?
...
**Cuestionario-REP_A_07052023 · nº 73 · respuesta: b**

```
En el ámbito de los servicios rurales, ¿quién se encarga de la gestión del almacén de material?
...
```
En una unidad de distribución, ¿para qué otro uso, además de repostar combustible, se puede utilizar la tarjeta de combustible?
...
**Cuestionario-REP_A_07052023 · nº 79 · respuesta: a**

```
El operador al que se le adjudica el servicio postal universal está obligado a cumplir los siguientes plazos de entrega de envíos nacionales:
...
```
En una unidad de distribución, ¿quién es el responsable de la no utilización de los EPI?
...
**Cuestionario-REP_A_07052023 · nº 94 · respuesta: d**

```
En distribución, ¿qué significa el reparto de valija unitoque?
...
```
¿Es posible entregar en un citypaq un envío con importes asociados?
...
**Cuestionario-REP_A_07052023 · nº 100 · respuesta: d**

```
En una unidad de distribución, ¿quién controla las valijas que se han recogido y comprueba que coinciden con las que muestra la pantalla de SGIE?
...
```
Los servicios rurales, ¿tienen que atender al público "al paso" durante su jornada laboral, para la admisión y venta de servicios a través de la PDA?
a) No
...
```
El personal rural de Correos, ¿puede recibir de un cliente solicitudes de envío de dinero?
