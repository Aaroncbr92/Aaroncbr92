# Correos · Tema 11 · Internacionalización y aduanas
...
**Cuestionario-ATC_A_07052023 · nº 13 · respuesta: b**

```
¿Cómo se llama el nuevo centro internacional de Correos que estará dedicado íntegramente al correo internacional de importación?
a) CTI Barajas
b) Rampa 7
c) CCP Barajas
d) CTP el Prat
...
```
De las siguientes opciones, ¿cuál no se corresponde exactamente con una de las asociaciones internacionales a las que pertenece Correos?
...
**Cuestionario-ATC_A_07052023 · nº 42 · respuesta: b**

```
A efectos fiscales y aduaneros, ¿cuál de las siguientes afirmaciones es incorrecta respecto a la situación de Canarias en el marco de la Unión Europea:
...
```
La legislación fiscal aplicable en España establece el principio general de que la introducción de mercancía se encuentra sujeta al pago de tributos a la importación. ¿En qué productos?
...
**Cuestionario-ATC_A_07052023 · nº 108 · respuesta: d**

```
En la actividad internacional de exportación de Correos, ¿qué tipo de prohibiciones se aplican?
...
```
En Madrid, ¿cuál es el centro internacional encargado de la expedición de todo el correo de exportación?
a) El CTI de Barajas
b) El CCP de Barajas
c) El CI3 de Barajas
d) Rampa 7
...
**Cuestionario-REP_A_07052023 · nº 21 · respuesta: d**

```
¿A qué se debe principalmente la expansión del negocio internacional del Grupo Correos en los últimos años?
...
```
En la actividad de importación de envíos postales con mercancía, Correos, como operador postal, actúa como representante aduanero y además… (señale la respuesta incorrecta):
...
**Cuestionario-REP_A_07052023 · nº 74 · respuesta: a**

```
¿Qué red le permite disponer de una amplia cobertura mundial al Paq Premium Internacional?
a) La red EMS
b) La red de Correos
c) La red Kahala
d) La red SPU
...
```
No requieren trámites aduaneros a la importación los envíos conteniendo mercancías con destino Canarias cuyo origen sea… (señale la respuesta correcta):
...
```
De los siguientes, ¿qué flujo de envíos, conteniendo mercancía, no están sujetos a tramitación aduanera?
