...
**Cuestionario-ATC_A_07052023 · nº 18 · respuesta: b**

```
En relación con los canales de atención al cliente de los que dispone Correos, señale cuál de las siguientes afirmaciones es correcta:
...
```
En el ámbito del márketing, ¿qué es un Lead?
...
**Cuestionario-ATC_A_07052023 · nº 74 · respuesta: b**

```
En relación con las reclamaciones de los clientes, señale cuál de las siguientes afirmaciones es correcta:
...
```
Si un cliente solicita en la oficina de Correos un formulario de la OMIC (Oficina Municipal de Información al Consumidor) para reclamar, ¿cuál es el proceso a seguir?
...
**Cuestionario-REP_A_07052023 · nº 20 · respuesta: a**

```
En el modelo de atención al cliente de Correos nuestro lema es… (señale la respuesta correcta):
...
**Cuestionario-REP_A_07052023 · nº 51 · respuesta: c**

```
En el trabajo de análisis realizado sobre la atención al cliente, ¿qué se entiende por "calidad percibida"?
...
```
De cara a la certificación ISO de calidad en Correos, ¿qué procesos cubre su alcance?
...
```
En relación con el sistema de identificación por radiofrecuencia (RFID), indique cuál de las siguientes afirmaciones es correcta:
