# Tema 4 del específico de Redactor/a · Fuentes informativas y verificación
...
> septiembre de 2026, anexo V, temario específico del puesto 2.34, punto 4):
>
> Fuentes informativas y verificación: fuentes oficiales, institucionales, sociales, documentales,
> judiciales, científicas y digitales; contraste, atribución, contextualización, verificación de
> imágenes, bulos, desinformación y obligaciones de diligencia profesional derivadas de la veracidad
> informativa.

**Qué se puede preguntar.** Los dos modos de enterarse de una noticia y el tercero (documentación);
qué fuente es mejor (la más próxima al hecho); por dónde empezar (oficiales, protagonistas,
...
- [1. Las fuentes y sus tipos](#1-las-fuentes-y-sus-tipos)
...
- [2. Contraste](#2-contraste)
  ...
  - [El triple aval de la fuente anónima](#el-triple-aval-de-la-fuente-anónima)
  - [Cifras propias: las manifestaciones](#cifras-propias-las-manifestaciones)
  - [Fuentes dudosas: las seis reglas de Bradlee](#fuentes-dudosas-las-seis-reglas-de-bradlee)
- [3. Atribución](#3-atribución)
  - [Decir de dónde viene](#decir-de-dónde-viene)
  - [Fórmulas que se rechazan y fórmulas que se admiten](#fórmulas-que-se-rechazan-y-fórmulas-que-se-admiten)
  - [Anonimato y confidencialidad](#anonimato-y-confidencialidad)
- [4. Contextualización](#4-contextualización)
- [5. Verificación de imágenes](#5-verificación-de-imágenes)
  - [La referencia](#la-referencia)
  - [Los cuatro principios](#los-cuatro-principios)
  - [Cuando lo que se emite es el desmentido](#cuando-lo-que-se-emite-es-el-desmentido)
- [6. Bulos y desinformación](#6-bulos-y-desinformación)
  - [El bulo en el Libro de Estilo](#el-bulo-en-el-libro-de-estilo)
  - [La definición oficial](#la-definición-oficial)
  - [El remedio: más periodismo, no menos](#el-remedio-más-periodismo-no-menos)
- [7. Obligaciones de diligencia derivadas de la veracidad](#7-obligaciones-de-diligencia-derivadas-de-la-veracidad)
  - [La ley: el artículo 9.1 de la Ley 13/2022](#la-ley-el-artículo-91-de-la-ley-132022)
  - [La doctrina: la Sentencia del Tribunal Constitucional 6/1988](#la-doctrina-la-sentencia-del-tribunal-constitucional-61988)
  - [Qué obligaciones concretas se siguen para el redactor](#qué-obligaciones-concretas-se-siguen-para-el-redactor)
...
### Cómo se conoce una noticia

El Libro de Estilo parte de una clasificación por el modo de acceso, no por el emisor:

> «**Sólo hay dos modos de enterarse de una noticia: el periodista ve lo que sucede o le cuentan, por
> medios diversos, lo que sucede.**» (4.3)

En ambos casos el espectador tiene derecho a saber cuál es el método, y «**hay que incluirlo como
referencia obligatoria, salvo que resulte obvio**»: si un líder político habla él mismo a cámara,
basta el rótulo. Y añade un tercero:

> «**Un tercer supuesto es el manejo de documentación, pública o privada, de la que se extraigan
> datos, conclusiones o detalles sorprendentes mediante su análisis.**»

### La jerarquía

«**La fuente es mejor cuanto más próxima está al hecho.**» Entre entes jurídicos, «**la mas adecuada
es la de mas prestigio institucional o social**» (así, sin tilde, en el original); entre personas,
«**el protagonista, el testigo directo o el de aquel cuya notoriedad personal o profesional sea más
elevada**», sin «**dejarse deslumbrar por un currículo lucido**». Y el orden de trabajo:

> «**Lo recomendable es empezar por las fuentes oficiales y los protagonistas o testigos y después
> contrastar su versión en otras instancias.**» (4.3)
...
- Sociales. Son las versiones privadas —ciudadanos, colectivos, organizaciones— y las fuentes
  ...
  regularidad y mide al periodista por «**la densidad y la extensión de su agenda**». La cautela:
...
El Libro de Estilo reserva la palabra para lo que sale del trabajo del periodista:

> «**Descartamos hablar de fuentes cuando la información vinculada no proceda del trabajo personal o
> coordinado del periodista.**» (4.3.5)

Si la noticia sale del comunicado de un ayuntamiento, se dice así y no se citan «fuentes
municipales»; lo mismo con ruedas de prensa, actos públicos y servicios de agencia a los que todos
los medios tienen acceso.

## 2. Contraste

### Una sola fuente no basta

> «**En todo caso es mucho peor utilizar una sola fuente sin contraste para ofrecer una noticia que
> acometer un proceso de comprobación**» (4.3.2)
...
Y la carta prohíbe informar sin conocer el origen: «**El o la periodista no informará sino sobre
hechos de los cuales él/ella conozca el origen, no suprimirá informaciones esenciales y no
falsificará documentos.**» (art. 3).

### El triple aval de la fuente anónima

Cuando la fuente es anónima —no conocida por el periodista ni respaldada por otro miembro de la
redacción o por una instancia segura—, sobre todo si imputa ilegalidades o acusa a terceros:

> «**deberá ser avalada, en primera instancia, por la comprobación de un redactor, posteriormente por
> medio de un soporte documental suficiente y, finalmente, en una instancia oficial que no ofrezca
> dudas.**» (4.3.5)

Tres pasos, en ese orden: redactor, documento, instancia oficial. Y la prevención «**es extensible
también a informaciones ajenas a cualquier conflicto**».

### Cifras propias: las manifestaciones
...
2. «**Hay que comprobar todas las referencias minuciosamente en su fase inicial.**»
3. «**Cuidado con las historias que, por lo que sea, te gustaría que fuesen ciertas.**»
4. «**Cuando se trate de algo realmente grande, busca a quien no esté de acuerdo y escúchale.**»
5. «**Si es algo realmente importante, busca a jefes y compañeros que tengan reservas.**»
6. «**Y nunca te desanimes por lo fácil que es que todo se vaya al traste después de lo difícil que
...
### Fórmulas que se rechazan y fórmulas que se admiten

Se rechazan, por vacías, «**fuentes solventes, fuentes bien informadas, fuentes dignas de todo
crédito, porque si no lo fueran, no serían utilizadas**» (4.3.2). Se admiten «**fuentes
parlamentarias, sindicales, empresariales, gubernamentales...**» sólo cuando de verdad lo son, y se
prefiere la más precisa: mejor «fuentes de la Dirección General de Pesca» que «la Consejería de
Agricultura», y descartable «fuentes de la Junta de Andalucía».

También se rechazan (4.3.4):

- los giros que disimulan la ausencia de fuente —«**se dice que..., al parecer..., hemos oído
  que**»—, porque «**Son evasivas de nuestra responsabilidad profesional**»;
- las expresiones evidenciales («dicen que alguien ha dicho...»): «**un hablante común puede hablar
  de oídas, pero un periodista no.**»;
- «**según ha podido saber Canal Sur**»: todo medio «sabe» lo que cuenta y está obligado a decir
  cómo lo ha sabido. Sólo cabe en un hecho excepcional y exclusivo, con autorización de la Dirección
  de los Servicios Informativos de la RTVA;
- las opiniones atribuidas a «observadores» o «analistas» sin identificar.
...
- La carta de la FIP obliga a respetar lo pactado: el periodista «**sí respetará las modalidades de
  difusión que hayan acordado libremente, como en "off", bajo anonimato o mediante embargo, siempre
  que estos compromisos sean claros e indiscutibles.**» (art. 14).

El secreto profesional como derecho está en el tema 1.
...
Costumbre de oficio, sin norma: cuando la pieza explica por qué un contenido es falso, hay que
enseñar el material dudoso sin volver a difundirlo, y mostrar el método de comprobación de manera
que el espectador pueda seguirlo.

## 6. Bulos y desinformación

### El bulo en el Libro de Estilo

El Libro de Estilo no usa «desinformación» (es de 2004), pero sí «bulo», y lo liga al rumor:

> «**No emitiremos jamás noticias basadas exclusivamente en un rumor, ni tampoco aceptaremos
> hipótesis ajenas o particulares como base de una noticia**» (4.3.4)

Los giros que disimulan la falta de fuente «**maquillan percepciones subjetivas o bulos que no han
sido confirmados y que, por tanto, tienen que ser descartados en una información.**» La regla de
fondo: «**Toda acción, cualquier noticia, se ciñe a un hecho, un protagonista y una fuente
informativa.**» El rumor puede servir de punto de partida para investigar, pero sólo será noticia
«si se consigue la confirmación necesaria».

### La definición oficial

La recoge la Orden PCM/1030/2020, de 30 de octubre, que publica el Procedimiento de actuación contra
la desinformación aprobado por el Consejo de Seguridad Nacional. Toma la de la Comisión Europea en
su Comunicación sobre la lucha contra la desinformación en línea, COM (2018) 236:
...
> pluralidad de opiniones a través de la promoción de un periodismo de alta calidad, que ofrezca
> información fiable, basada en hechos y verificada, así como en desarrollar la alfabetización
> mediática, y que tales medidas deben proporcionar garantías para la libertad de información y la
...
### La ley: el artículo 9.1 de la Ley 13/2022

La Constitución protege el derecho a comunicar o recibir libremente información **veraz** (art.
20.1.d; tema 1). La LGCA lo concreta para los informativos en su artículo 9, «Veracidad de la
información»:
...
El deber es de diligencia «en la comprobación de los hechos»: se exige comprobar, no acertar
siempre.

### La doctrina: la Sentencia del Tribunal Constitucional 6/1988

La STC 6/1988, de 21 de enero (Sala Primera), explica qué significa «veraz» en el artículo 20 de la
Constitución. Su fundamento jurídico 5:

> «**Cuando la Constitución requiere que la información sea «veraz» no está tanto privando de
> protección a las informaciones que puedan resultar erróneas -o sencillamente no probadas en
> juicio- cuanto estableciendo un específico deber de diligencia sobre el informador, a quien se le
> puede y debe exigir que lo que transmita como «hechos» haya sido objeto de previo contraste con
> datos objetivos, privándose, así, de la garantía constitucional a quien, defraudando el derecho de
> todos a la información, actúe con menosprecio de la veracidad o falsedad de lo comunicado. El
> ordenamiento no presta su tutela a tal conducta negligente, ni menos a la de quien comunique como
> hechos simples rumores o, peor aún, meras invenciones o insinuaciones insidiosas, pero sí ampara,
> en su conjunto, la información rectamente obtenida y difundida, aun cuando su total exactitud sea
> controvertible. En definitiva, las afirmaciones erróneas son inevitables en un debate libre, de
> tal forma que, de imponerse «la verdad» como condición para el reconocimiento del derecho, la única
...
### Qué obligaciones concretas se siguen para el redactor

Las reglas de los epígrafes anteriores son la forma práctica de esa diligencia:

- contrastar los datos en fuentes oficiales o citar con precisión su origen (Libro de Estilo, 4.3.2);
- no emitir nada basado sólo en un rumor (4.3.4), que es exactamente lo que la STC deja sin
  protección;
- avalar la fuente anónima por el redactor, un documento y una instancia oficial (4.3.5);
- recabar la versión del afectado o explicar por qué no se tiene (4.3);
- no dejar que la urgencia prevalezca sobre la verificación (carta de la FIP, art. 5);
- verificar autor, lugar, fecha y contexto de las imágenes ajenas (epígrafe 5);
- y, si pese a todo hay un error, rectificar: la carta pide hacerlo «**de manera rápida, explícita,
  completa y visible**» (art. 6). El derecho de rectificación de la Ley Orgánica 2/1984 está en el
  tema 1.

## Normativa que el tema invoca

| Norma o documento | Preceptos |
|---|---|
...
- Verificación en redes y obligaciones de las plataformas (Reglamento de Servicios Digitales):
  tema 14. Verificación en directo: tema 10. Herramientas de inteligencia artificial: tema 19.
- Secreto profesional, derecho de rectificación y derecho a la propia imagen: tema 1. Imágenes de
  personas identificables: tema 16. Carta de la FIP completa: tema 18.
