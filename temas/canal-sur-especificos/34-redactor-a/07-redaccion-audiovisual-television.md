# Tema 7 del específico de Redactor/a · Redacción audiovisual para televisión
...
> guion informativo, relación texto-imagen y adaptación al tiempo de emisión.»

Qué se puede preguntar: los cuatro párrafos de la noticia básica y a qué pregunta responde cada uno; el
largo de las frases; qué llama Canal Sur «entradilla», «medianilla» y «salidilla» y cuál recomienda;
qué es un total y cuánto dura; colas, intro e intro colas; las duraciones de referencia de cada formato;
lo que no puede llevar un titular; qué contiene la escaleta; las cuatro condiciones del montaje; cómo
se prepara un vídeo para que aguante recortes y reemisiones.

<!-- indice -->

## Índice

- [1. Estructura de la noticia](#1-estructura-de-la-noticia)
  - [Los cuatro párrafos](#los-cuatro-párrafos)
  - [El texto y la frase](#el-texto-y-la-frase)
  - [Imágenes falsas y música](#imágenes-falsas-y-música)
- [2. Entradilla](#2-entradilla)
...
- [3. Off](#3-off)
  ...
  - [Los cuatro defectos del texto (6.2.2, p. 90)](#los-cuatro-defectos-del-texto-622-p-90)
- [4. Totales](#4-totales)
- [5. Colas](#5-colas)
  - [Formatos vecinos](#formatos-vecinos)
- [6. Piezas](#6-piezas)
  - [Duraciones de referencia](#duraciones-de-referencia)
  - [Informe, reportaje y crónica](#informe-reportaje-y-crónica)
- [7. Titulares](#7-titulares)
- [8. Rótulos](#8-rótulos)
  - [Cuándo se rotula](#cuándo-se-rotula)
- [9. Guion informativo](#9-guion-informativo)
...
duraciones que siguen son, por eso, referencias; las prohibiciones, no.
...
- **«El texto debe ser directo, claro, conciso, interesante y fácilmente comprensible. El espectador no
  puede releer como en un periódico.»** (p. 45)
- **«Son poco recomendables las oraciones subordinadas, las formas verbales pasivas o construcciones
  negativas. Las frases serán cortas, sobre todo al principio, con estructuras gramaticales simples de no
...
- **«El paso tiene que explicarse en sí mismo. El periodista que elabora el vídeo es el encargado de
  escribirlo aunque después será revisado por el presentador y los editores»**.
...
### Los cuatro defectos del texto (6.2.2, p. 90)
...
- Informe (3.3): **«explica las consecuencias o los antecedentes de un hecho»**; **«se basa siempre en
  datos y estadísticas solventes u oﬁciales»**; **«El informe corresponde a un periodista especializado
  que se responsabiliza de la versión ﬁnal, en la que puede incluir su propia perspectiva analítica.
  Este apunte excluye la opinión particular»**.
...
- Crónica (3.5): **«muestra una perspectiva singular, acotada a un tiempo concreto, según el criterio
  del periodista que es testigo de un acontecimiento. No es un género de opinión pero concede libertad
  narrativa»**. En la crónica telefónica, **«En pantalla aparecerá un 'cartón' con imagen de
  postproducción, un mapa y/o el rostro del periodista.»**
...
importante, relevante y sugestivo de un informativo.»** (3.6, pp. 50-51)

- Duración: **«es recomendable que cada titular no se prolongue, en toda su extensión, por encima de
  los diez segundos.»**
- Lectura: **«suele ser leído por los locutores, con alternancia de voces, en forma de 'colas' o está
  previamente grabado»**.
...
**«El rótulo que acompaña es también información. Reúne brevedad, impacto y síntesis.»** (3.6.1, p.
50). Se admite la coma por el verbo: **«podemos sustituir el verbo de un rótulo por una coma [...] es
admisible optar por Los aeropuertos, en alerta.»** (p. 51)

El Manual de estilo de RTVE (2.2.8) da la razón de la brevedad: **«Conviene ponderar la importancia
del rótulo que acompaña al titular porque significa condensar una noticia en muy pocas palabras»**;
**«el telespectador, por diversas circunstancias, puede estar fijando la atención más en lo que ve que
en lo que oye. Es primordial no distraer al espectador con rótulos extensos y/o poco enriquecedores»**
de la información principal; y **«es necesario extremar la precaución en la escritura del texto. Los
cambios introducidos en los sistemas de trabajo y la reducción de filtros correctores pueden propiciar
errores, especialmente ortográficos.»**

### Cuándo se rotula

| Caso | Fuente |
|---|---|
| Reconstrucción o simulación: rótulo **«'reconstrucción'»** todo el tiempo que estén en pantalla | Libro de estilo 3.2.2 |
| Entrevista: **«Es necesario prever la inclusión de rótulos, al menos en una ocasión, muy especialmente cuando registremos primeros planos.»** | Libro de estilo 3.17.1.1, p. 59 |
| Intro: **«Suele ser necesaria la rotulación con el dato del momento y el lugar»** | Libro de estilo 3.13 |
...
## 11. Adaptación al tiempo de emisión
...
- Géneros (definición de crónica, reportaje, entrevista): tema 5. Escaleta y mesa de redacción: tema 3.
  Radio: tema 8. Locución y prompter: tema 9. Directos: tema 10.
