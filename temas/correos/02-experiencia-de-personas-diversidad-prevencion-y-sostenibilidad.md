...
Boletín Oficial del Estado. La otra mitad es material de empresa: programas, planes, marcas, cifras
de memoria corporativa. **El temario trata cada mitad como merece**: la primera se comprueba contra
la norma, y cuando la norma dice algo distinto se dice; la segunda se da como lo que es, la
...
**El documento abre con cuatro ejes de actuación**, y conviene retenerlos porque son el armazón de
todo el epígrafe 2.1:

| Eje | Qué agrupa |
|---|---|
| **Generar empleo de calidad** | **Estabilización del empleo** y **gestión del talento** |
...
> del Grupo Correos, uno de los grupos públicos con mayores dimensiones y capital humano.**»

### La experiencia de empleado y su ciclo de vida

**La experiencia de empleado se construye a través de las interacciones entre los trabajadores y la
organización**, y Correos la gestiona mediante el **Programa de Experiencia Empleado**, que es **un
canal de escucha**. **Lo preguntable son las cinco fases del ciclo de vida**, en este orden:

| Fase | Qué contiene |
|---|---|
| **1. Atracción y captación** | El apartado **«Personas y Talento»** de la web, con el espacio **Comunidad del Talento**: información de programas, alta de perfil, revisión de procesos activos y **alertas de empleo** |
| **2. Selección** | **Cuestionarios de experiencia a las personas candidatas**, incorporados a los procesos publicados en la Comunidad de Talento |
| **3. Acogida** | El **Programa de Acogida y Seguimiento**, con hitos definidos para **los primeros seis meses** |
| **4. Desarrollo profesional** | El **Programa de Sustituciones** —formación y experiencia en **Dirección de Oficinas y Jefaturas de Unidad**— y los programas **clic** y **Correos en femenino** |
| **5. Salida** | **Entrevistas de salida** a quienes formaban parte del sistema de evaluación del desempeño, para identificar **factores de riesgo de pérdida de talento** |

**Las herramientas de medición son de participación voluntaria**: entrevistas, grupos de discusión y
cuestionarios.

### Formación y capacitación

**El espacio de referencia es el Campus Virtual de Correos**, y dentro de él el documento distingue
ámbitos didácticos que un examen puede pedir por su nombre exacto:

| Ámbito | Para qué |
|---|---|
| **Escuela de productos** | **Autoaprendizaje continuo** sobre oferta comercial, con videotutoriales para la red de oficinas y **certificación del aprendizaje mediante el proyecto «Verifícate»** |
| **Escuela de ventas** | **Ampliar y homogeneizar la capacitación de los gestores comerciales** y profesionales de oficinas |
| **Escuela de formadores** | **Capacitar a profesionales de la compañía para liderar acciones formativas internas** |
| **Expertos de conocimiento** | **Colaboración de profesionales con amplia experiencia** en la creación y actualización de contenidos |
| **Programa de acompañamiento** | En **oficinas, centros y distribución**, para la transferencia de conocimientos |
| **Espacio de formación continua** | Contenidos para el trabajo diario |
| **Cursos de formación en abierto** | Convocatorias periódicas |
...
**Las dos definiciones del documento hay que sabérselas separadas**, porque el examen las cruza.
**Diversidad**, citada:

> «**Es la convivencia e interacción entre personas con diferencias de género, generación,
> discapacidad, cultura... que hacen a las personas únicas, y a Correos tan heterogéneo como la
> sociedad.**»
...
**El documento da tres razones** por las que la diversidad importa en Correos: **porque es empresa
pública**; **porque es reflejo de una sociedad cada vez más heterogénea**; y **porque existe un
compromiso con el cambio**. **Y da cinco costes de no gestionarla**: **coste económico directo sobre
los resultados**; **pérdida de compromiso del personal**; **riesgo de pérdida de confianza de los
accionistas**; **pérdida de lealtad de clientes y proveedores**; y **coste social hacia los
stakeholders y su entorno**.

### Los sesgos

**Cuatro, con nombre propio**, y es una lista muy preguntable:

| Sesgo | En qué consiste |
|---|---|
| **De afinidad** | **Evaluar de forma más positiva a personas con características similares a uno mismo** |
| **De confirmación** | **Buscar información o comportamientos que respalden las imágenes preconcebidas** |
| **Efecto de halo** | **Centrar la atención en un aspecto positivo concreto para la percepción general** |
| **Basarse en estereotipos** | **Creer que por su origen o condición alguien cumple unas características y patrones concretos sin previa comprobación** |

### Los siete ejes y las cinco dimensiones

**Aquí hay una simetría que conviene fijar, porque son dos listas distintas y el examen las
intercambia.** **A través del Plan de Diversidad e Inclusión se gestionan cinco dimensiones y se
articulan siete ejes de actuación.**

| Los siete ejes | Las cinco dimensiones |
|---|---|
| **Promoción** | **Género** |
| **Formación** | **Generacional** |
| **Talento** | **Cultural** |
| **Cultura** | **Personas con discapacidad o diversidad funcional** |
| **Sostenibilidad (RSC)** | **LGBTIQ+** |
| **Empresa Saludable** | |
...
| Mes | Hito |
|---|---|
| **Febrero** | **Mujer STEM** (ciencias, tecnología, ingeniería y matemáticas) |
| **Marzo** | **Mes de la mujer** |
| **Abril** | **Mes de la diversidad intergeneracional** |
| **Junio** | **Mes LGBTIQ+** |
| **Octubre** | **Mujer rural** |
| **Noviembre** | **Contra la violencia de género** |
| **Diciembre** | **Personas con discapacidad** |

## 3. La normativa de prevención, y de dónde viene

**El documento cuenta la historia de la prevención en España a partir de la democracia**, y encadena
cuatro hitos con fecha. **Los cuatro se han comprobado a la vista sobre la página impresa**, porque
los cuatro venían corrompidos del reconocimiento óptico:

| Año | Hito |
|---|---|
| **1978** | **La Constitución**, que implanta el modelo territorial autonómico. **El Instituto Nacional de Seguridad e Higiene en el Trabajo no se constituyó hasta ese año**, adscrito al Ministerio de Trabajo |
| **1980** | **El Estatuto de los Trabajadores**, que incorpora al contrato de trabajo las condiciones de seguridad e higiene y separa enfermedades y accidentes de trabajo, que pasan a la Seguridad Social |
| **1986** | **La incorporación de España a la Unión Europea**, el 1 de enero |
| **1989** | **La Directiva 89/391/CEE del Consejo, de 12 de junio**, de la que sale la vigente **Ley 31/1995** |

**Ahí hay una precisión que el documento no hace y el temario sí.** **El Instituto se llama hoy
Instituto Nacional de Seguridad y Salud en el Trabajo**, y el propio documento usa las dos
...
**El documento reproduce dos artículos completos**, y son los dos que hay que distinguir:

| Artículo | Órgano | Qué es |
|---|---|---|
| Artículo **8** de la Ley 31/1995 | **Instituto Nacional de Seguridad e Higiene en el Trabajo** | **El órgano científico técnico especializado de la Administración General del Estado**, con misión de **análisis y estudio** de las condiciones de seguridad y salud |
| Artículo **9** de la Ley 31/1995 | **Inspección de Trabajo y Seguridad Social** | **La función de vigilancia y control** de la normativa de prevención |

**La diferencia de fondo está en una sola facultad**, y es de las más preguntadas: **el Instituto
asesora y estudia; la Inspección puede ordenar la paralización inmediata de los trabajos.** El texto
de la Ley 31/1995, citado:
...
**Diecisiete normas, y el documento las da en orden cronológico.** **Tres de ellas cayeron
corrompidas en el volcado y se han corregido a la vista**: se señalan con su fecha porque **la fecha
es lo que distingue los cuatro reales decretos de 1997 que comparten el día 14 de abril**.
...
| **Real Decreto 486/1997**, de 14 de abril | **Lugares de trabajo** |
| **Real Decreto 487/1997**, de 14 de abril | **Manipulación manual de cargas** |
| **Real Decreto 488/1997**, de 14 de abril | **Pantallas de visualización** |
| **Real Decreto 773/1997**, de 30 de mayo | **Equipos de protección individual**, hoy modificado por el **Real Decreto 1076/2021** |
| **Real Decreto 1215/1997**, de 18 de julio | **Equipos de trabajo** |
| **Real Decreto 614/2001**, de 8 de junio | **Riesgo eléctrico** |
| **Real Decreto 171/2004**, de 30 de enero | **Coordinación de actividades empresariales** (desarrolla el artículo 24 de la Ley 31/1995) |
| **Real Decreto 2267/2004**, de 3 de diciembre | **Incendios en establecimientos industriales** |
| **Real Decreto 286/2006**, de 10 de marzo | **Ruido** |
| **Real Decreto 314/2006**, de 17 de marzo | **Código Técnico de la Edificación** |
| **Real Decreto 604/2006** | **Integración de la prevención en el sistema general de gestión** |
| **Real Decreto Legislativo 6/2015**, de 30 de octubre | **Tráfico, Circulación de Vehículos a Motor y Seguridad Vial** |
| **Real Decreto 513/2017**, de 22 de mayo | **Instalaciones de protección contra incendios** |

**Las cuatro fechas de abril de 1997 son la trampa clásica**, y hay una regla mnemotécnica que el
documento no da y funciona: **485 señalización, 486 lugares, 487 cargas, 488 pantallas**, en orden
creciente de número y de concreción, **de lo que se ve a lo que se mira**.

## 4. La política y la estructura de prevención en Correos

**Cuatro puntos clave**, y el documento los enumera antes de desarrollarlos: **definición de
...
| Aspecto | Precepto que el documento invoca |
|---|---|
| **Mejora continua**, como «acción permanente para mejorar los niveles existentes» | Artículo **14** de la Ley 31/1995 |
| **Integración** de la actividad preventiva en el conjunto de actividades y decisiones | Artículo **1.1** del Reglamento de los Servicios de Prevención |
| **Definición de funciones y responsabilidades** en todos los niveles jerárquicos | Artículo **2.1** del Reglamento de los Servicios de Prevención |
...
> de ejecutar ni de hacer ejecutar el Sistema de Gestión de PRL.**»
...
**Ésta es la pregunta de examen más previsible del tema entero**, porque tiene números:

| Modalidad | Cuándo procede |
|---|---|
| **Asumida personalmente por el empresario** | Empresas de **hasta diez trabajadores**, o **veinticinco** si hay **un único centro de trabajo** y la actividad no está en el **Anexo I del RSP**; además el empresario ha de **realizar su actividad de manera habitual en el centro** y **tener la capacidad necesaria** |
| **Designación de uno o varios trabajadores** | Han de ser **suficientes en número** y contar con **capacitación, medios y tiempo suficientes** |
| **Servicio de prevención propio** | **Obligatoria con más de 500 trabajadores**, o **250** si hay actividades del **Anexo I**, **o cuando lo decida la Autoridad Laboral** en atención a la peligrosidad o a la siniestralidad |
...
| Especialidad | Objetivo | Qué estudia |
|---|---|---|
| **Seguridad en el trabajo** | **Prevenir los accidentes laborales** | **Los riesgos y las condiciones materiales**. Las actuaciones están catalogadas por el INSST en familias: **lugar y superficie de trabajo, herramientas, máquinas, electricidad, incendios, almacenamiento, manipulación y transporte de cargas, señalización y mantenimiento** |
| **Higiene industrial** | **Prevenir las enfermedades profesionales** | **Contaminantes químicos** (gases, vapores, aerosoles), **físicos** (ruido, vibraciones, temperatura, iluminación) **y biológicos** (virus, bacterias, hongos) |
...
duración determinada**, de modo que **dura lo que dure su condición de representante de los
trabajadores**.
...
**El tiempo dedicado a la formación es tiempo de trabajo efectivo a todos los efectos, y su coste no
puede recaer en ningún caso sobre los delegados.** **Las competencias están en los artículos 36 y 37
de la LPRL**, y la que más se pregunta es **ser consultados con carácter previo a la ejecución** de
las decisiones sobre planificación del trabajo, nuevas tecnologías, designación de encargados de
emergencia y planificación de la formación preventiva.
...
|---|---|
| **Derecho a la protección frente a los riesgos laborales** | Artículo **14** |
...
|---|---|---|
| **PR002** | **Evaluación de riesgos** | El concepto de **puesto de trabajo preventivo (PTP)**, que **agrupa a los trabajadores que realizan funciones similares y están sometidos a los mismos riesgos** |
| **PR004** | **Investigación de los accidentes laborales** | La distinción entre **causas inmediatas** —acciones y condiciones inseguras— y **causas básicas** —factores personales y del trabajo—. **De las básicas salen las medidas correctoras** |
...
**Los puestos de trabajo preventivos tienen número, y el número no es correlativo**, que es
precisamente lo que hace la pregunta:

| Proceso | Puesto | Código |
|---|---|---|
| **Recepción y entrega** | **D. Oficina** | **PTP-5** |
| | **At. Cliente** | **PTP-4** |
| **Tratamiento** | **Jefe de tratamiento** | **PTP-8** |
| | **Ag. Clasificador 1 · Carretillero** | **PTP-2** |
| | **Ag. Clasificador 2** | **PTP-3** |
| | **Ag. Clasificador 2 · Centros pequeños** | **PTP-3.1** |
| **Distribución** | **Jefe de distribución** | **PTP-7** |
...
**Ocho definiciones, y la diferencia entre dos de ellas es la pregunta**:

| Tipo | Definición |
|---|---|
| **Con lesión a personas** | **Toda lesión corporal que el trabajador sufre con ocasión o por consecuencia del trabajo que ejecute** |
| **Sin baja** | **Requiere asistencia médica pero permite volver al trabajo dentro del mismo día o turno o al comienzo del siguiente** |
| **Con baja** | **Impide la asistencia al trabajo por un periodo mayor de un día o turno** |
| **Grave** | **Calificado como tal por el servicio médico que atiende** |
| **Mortal** | **Se produce el fallecimiento de uno o varios trabajadores** |
| **In misión** | **El sufrido en el trayecto para el cumplimiento de la misión, y el acaecido en su desempeño dentro de la jornada** |
| **In itinere** | **El producido en el camino de ida o vuelta del trabajo**, con baja o sin ella |
| **Material** | **No se producen daños personales** pero hay pérdidas económicas importantes |
...
**Siete protocolos específicos**: **pantallas de visualización de datos**; **manipulación manual de
cargas**; **ruido**; **movimientos repetitivos del miembro superior**; **posturas forzadas**;
**trabajadores nocturnos**; y **conductores**.

**Cuatro grados de aptitud**, y los dos últimos se subdividen por su duración:

| Grado | Qué significa |
|---|---|
| **Apto** | **Capacitado para realizar todas las funciones de su puesto** |
| **Apto con limitaciones** | **Puede realizar la mayoría de las funciones, con medidas restrictivas en una o varias tareas** |
| **No apto temporalmente** | **No capacitado para una o varias tareas de manera temporal** |
...
**Las medidas del PR017 se agrupan en tres verbos**, y las cifras son muy preguntables:

| Verbo | Medidas con cifra |
|---|---|
| **No realizar** | **Turno de noche o turnos rotativos**; **carga y descarga de conducciones**; **traspaleta**; **carretilla elevadora**; **productos químicos perjudiciales**; **vibraciones**; **moto o bici**; **espacios confinados**; **trabajos de altura** |
...
| Código | Protocolo | El dato que se pregunta |
|---|---|---|
| **PT001** | **Seguridad en el manejo de carros y jaulas** | **No sobrepasar 10 alturas de bandejas tipo A o 5 de bandejas tipo B o C** al cargar los carros |
| **PT004** | **Seguridad en la carga de reparto en moto** | **Carga máxima: 50 Kg**. La carga va **exclusivamente en el cofre trasero** |
| **PT005** | **Agresiones de perros** | **Ahuyentador de perros** como EPI, y el depósito **en lista de la oficina más próxima** si no se adoptan medidas correctoras |
...
**Correos tiene certificado su sistema de Excelencia Empresarial Saludable**, y esa página del
documento sí trae capa de texto, de modo que sus cifras no vienen del reconocimiento óptico:

| Dato | Valor |
|---|---|
| **Entidad certificadora** | El **Laboratori General d'Assaigs i Investigacions (LGAI) Technological Center, S.A.**, que opera como **Applus+** |
| **Puntuación** | **91,5 %** |
...
| Fuente | Definición |
|---|---|
| **Observatorio de Responsabilidad Social Corporativa** | **Una forma de dirigir la empresa basada en la gestión de los impactos que su actividad genera** sobre clientes, empleados, accionistas, proveedores, comunidades locales, medioambiente, Administraciones públicas, medios de comunicación y la sociedad en su conjunto |
| **Comisión Europea** | **La «integración voluntaria por las empresas de preocupaciones sociales y medioambientales en sus actividades comerciales y en las relaciones con todos los actores interesados en aquellas»** |

**A esos colectivos se los llama grupos de interés o stakeholders.** **Y las tres dimensiones del
equilibrio que la RSC persigue son la económica, la social y la medioambiental.**

**La historia tiene tres hitos con fecha en Correos**, y el examen los pide por año:

| Año | Hito |
|---|---|
| **2002** | **Adhesión de Correos al Pacto Mundial de las Naciones Unidas**, con sus **Diez Principios** en materia de **Derechos Humanos, Normas Laborales, Medioambiente y Anticorrupción** |
...
**Las cifras de este epígrafe son las más preguntadas del tema entero**, y todas se han comprobado a
la vista porque **la que el reconocimiento devolvía estaba mal en dos de ellas**:
...
| **Cumbre** | **Nueva York, entre los días 25 y 27 de septiembre de 2015** |
| **Líderes mundiales que lo aprobaron** | **193** |
| **Horizonte** | **2030** |
...
**Y sus tres elementos básicos son el crecimiento económico, la inclusión social y la protección del
medioambiente.**

## 10. Los ejes de la sostenibilidad en Correos

**El Modelo de Alineación con los ODS tiene tres líneas de actuación prioritarias y dos ejes
transversales**, y el documento repite la lista dos veces con redacción ligeramente distinta:

| Las tres líneas | En qué consiste |
|---|---|
| **Negocio e innovación social** | **Diseño y comercialización de productos y servicios sostenibles**, frente a **despoblación rural, brecha digital y cambio climático** |
| **Relación con la comunidad** | **Actuaciones con impacto local** en colaboración con asociaciones y entidades no gubernamentales |
| **Gestión sostenible** | **Políticas internas** de desarrollo de las personas, diversidad, cadena de suministro, protección medioambiental y buen gobierno |

**Los dos ejes transversales son la contribución a los ODS y la respuesta al reto demográfico.**

### Los cuatro compromisos para 2030

**Correos los presentó durante la Cumbre del Clima 2019, la COP 25, celebrada en Madrid**:

| Compromiso | Contenido |
|---|---|
| **Neutralidad en emisiones** | **Alcanzar la neutralidad total en emisiones de CO₂** |
| **Circularidad** | **Ser una empresa que genere «residuo cero» antes de 2030** |
| **Movilidad inteligente** | **Que el 50 % de la flota de la compañía utilice tecnologías alternativas** |
| **Valor local** | **Aumentar la diversidad de productos sostenibles** en Correos Market y en las oficinas |

### Negocio e innovación social

**Las cifras de la red rural son de las más preguntadas**, y conviene darlas con su contexto porque
**el documento ofrece dos números distintos de oficinas en páginas distintas**:

| Dato | Valor |
|---|---|
| **Profesionales de reparto rural** | **6.011** |
| **Oficinas**, en el epígrafe de servicios de proximidad | **cerca de 2.370** |
| **Oficinas**, en el epígrafe de compromiso con la comunidad y en el de movilidad | **cerca de 2.400** |
| **Cajeros automáticos en oficinas** | **1.200** |
| **Cajeros en pequeñas poblaciones rurales sin oficina bancaria** | **300** |
| **Carteros y carteras** | **más de 30.000** |
...
| Dato | Valor |
|---|---|
| **Voluntarios y voluntarias movilizados** | **3.292** |
| **Iniciativas solidarias** | **cerca de 500**, durante **diez semanas** de confinamiento |
| **Beneficiarios**, a finales de mayo de 2020 | **más de 815.000** |
| **Kilos de alimentos distribuidos** | **más de 942.000** |
| **Artículos sanitarios o de protección** | **más de 1,2 millones** |
| **Empresas colaboradoras** | **más de 360** |
| **Entidades sociales** | **190** |
| **Administraciones públicas** | **150** |

**El lema fue «Ayudar en todo lo que podamos»**, y la coordinación de la recogida de alimentos
corresponde a la **Federación Española de Bancos de Alimentos (FESBAL)**.

### Gestión sostenible

**El marco europeo tiene dos piezas y dos porcentajes**, y el porcentaje español venía corrompido en
el volcado:

| Instrumento | Objetivo |
|---|---|
| **Pacto Verde Europeo** | **Reducir las emisiones del transporte un 90 %** y **alcanzar la neutralidad total para 2050** |
| **Plan Europeo de Recuperación NextGenerationEU** | Incluye la **movilidad sostenible e inteligente** en su programa de transición ecológica |
| **Ley 7/2021, de Cambio Climático y Transición Energética** | **Zonas de bajas emisiones en todas las ciudades de más de 50.000 habitantes** |
| **PNIEC 2021-2030** | **Mitigación del 39 % en 2030** para los sectores difusos, y **28 % de renovables en la movilidad en 2030** |

**El sector del transporte representa una cuarta parte de las emisiones totales de gases de efecto
invernadero**: ése es el dato que justifica todo lo anterior.
...
**De la movilidad, cuatro adjetivos y sus cifras**:

| Adjetivo | Contenido |
|---|---|
| **Sostenible** | **Más del 95 % de las rutas regulares de larga distancia tienen el distintivo ambiental de la Dirección General de Tráfico (ECO)**; **el 100 % de la electricidad adquirida es renovable con garantía de origen**; **más de 30.000 carteros y carteras** hacen entregas cero emisiones a pie |
| **Inteligente** | **Digitalización y optimización de rutas**, **robotización** |
| **Local** | **Citypaq** y **cerca de 2.400 oficinas**, sin distintivo alguno de por medio |
| **Consciente** | **Ofrecer al cliente condiciones de envío de menor coste climático** |

**Desde 1996 Correos evalúa e incorpora medios de transporte con combustibles alternativos**, y
**además de los eléctricos prueba GLP —dentro del proyecto europeo POSTLowCIT— y GNC**, tanto para
...
| Proyecto | Quién lo lidera | Qué hace |
|---|---|---|
| **POSTLowCIT** | **Correos** | **Testeo de combustibles alternativos** y sistema de información para optimizar la última milla |
| **ECO-GATE** | **Gas Natural Fenosa**, con Correos **desde 2017** | **Evalúa furgonetas de gas natural comprimido**, transformadas o nativas, frente a las diésel |
...
**De los inversores, los tres tipos**: **inversores particulares o business angels**; **fondos de
inversión especializados en startups**; y **plataformas de inversión colectiva o crowdfunding**.
...
**aportación económica**, **uso del espacio de CorreosLabs**, y **coaching y mentoring interno y
...
comunicación**, **coordinan el seguimiento de los hitos** y **presentan los resultados al resto de
áreas**.

## 12. Lo que este tema no da, y dónde está
...
| **El III Convenio Colectivo de Correos** | Boletín Oficial del Estado | **NO volcado.** El documento lo fecha en **2009-2013** y **conviene comprobar si sigue siendo el vigente** |
| **El Plan de Prevención de Correos** y sus procedimientos completos | Documentación interna de la empresa | **NO volcados**: se da lo que el documento de referencia resume de cada uno |
| **La Agenda 2030 y la resolución de Naciones Unidas** | Naciones Unidas | **NO volcadas**: se dan las cifras y fechas que el documento ofrece |
| **La Ley 7/2021 de Cambio Climático** y el **PNIEC** | Boletín Oficial del Estado y Ministerio | **NO volcados**: se nombran sus objetivos tal como el documento los resume |
...
único que delata ese error es saber que las metas de la Agenda 2030 son ciento sesenta y nueve.**

**La segunda: los códigos.** **El reconocedor lee el cero de los códigos de procedimiento como letra
O**, y devolvía **«PROO02»**, **«PROO5»** y **«PTOO4»**. **La página imprime «PR002» y «PT004»**,
comprobado a la vista, y de ahí se ha deducido el resto por patrón. **Quedan sin corregir los
