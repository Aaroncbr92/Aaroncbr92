...
//        desde?: {n: 'verificar'|'refutar'|'esquema'}}  ← continuar un puesto cortado: sin investigar, cada tema desde esa fase
const ORDEN = ['redactar', 'verificar', 'refutar', 'esquema']
const hace = (n, fase) => !args.desde || ORDEN.indexOf(fase) >= ORDEN.indexOf(args.desde[String(n)] || 'esquema')
