...
const tema = async (n, bloque) => {
  ...
  await A(`${BASE}\nESQUEMA de ${F} en ${ED}/ con el mismo nombre, con el formato de esquemas/canal-sur-comun/ (mira uno solo). Telegráfico, fuente delante de cada línea, ≤2.000 palabras / 130 líneas; se quita explicación, nunca un dato; nada que no esté en el tema.`, { label: lb('esquema'), phase: ph, model: 'sonnet' })
  return T
}
